...
* As rotas disponíveis são: ```/dashboard```, onde poderemos ter acesso à todas as notícias do usuário logado, e ```users/logout``` onde realizará o processo de logout do usuário e irá invalidar o token usado pelo mesmo, fazendo necessário realizar o processo de login novamente., 
